...
assert(html.includes("const APP_BUILD = '2026.07.30'"));
assert(html.includes("const RELEASE_ID = '20260730-callback-picker-r1'"));
assert(html.includes("const ROLLBACK_BASE_COMMIT = '1696b3b6333f5de59532209b557452e8f2d4584c'"));
assert(index.includes('aresfit-dialer-sandde-v2.html?v=20260730-callback-picker-r1'));
