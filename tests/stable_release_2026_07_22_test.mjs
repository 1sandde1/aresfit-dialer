...
vm.runInContext(`
  assert.equal(APP_BUILD, '2026.08.17');
  assert.equal(RELEASE_ID, '20260817-uk-callback-display-r1');
...
assert(index.includes('20260817-uk-callback-display-r1'), 'entry file cache bust does not match the release');
