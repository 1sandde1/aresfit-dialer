...
vm.runInContext(`
  assert.equal(APP_BUILD, '2026.07.30');
  assert.equal(RELEASE_ID, '20260730-callback-picker-r1');
...
assert(index.includes('20260730-callback-picker-r1'), 'entry file cache bust does not match the release');
