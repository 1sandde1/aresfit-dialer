...
vm.runInContext(`
  assert.equal(APP_BUILD, '2026.08.25');
  assert.equal(RELEASE_ID, '20260825-owr-001-mobile-r1');
...
assert(index.includes('20260825-owr-001-mobile-r1'), 'entry file cache bust does not match the release');
