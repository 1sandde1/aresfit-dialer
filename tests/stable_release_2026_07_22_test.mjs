...
vm.runInContext(`
  assert.equal(APP_BUILD, '2026.07.26');
  assert.equal(RELEASE_ID, '20260726-retry-override-r1');
...
assert(index.includes('20260726-retry-override-r1'), 'entry file cache bust does not match the release');
