...
assert(html.includes("const APP_BUILD = '2026.07.30'"), 'upload layout release build is missing');
assert(html.includes("const RELEASE_ID = '20260730-callback-picker-r1'"), 'upload layout release ID is missing');
