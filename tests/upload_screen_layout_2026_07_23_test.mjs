...
assert(html.includes("const APP_BUILD = '2026.08.25.1'"), 'upload layout release build is missing');
assert(html.includes("const RELEASE_ID = '20260825-owr-001-mobile-overflow-r1'"), 'upload layout release ID is missing');
