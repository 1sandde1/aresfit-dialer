...
assert(html.includes("const APP_BUILD = '2026.07.26'"), 'upload layout release build is missing');
assert(html.includes("const RELEASE_ID = '20260726-retry-override-r1'"), 'upload layout release ID is missing');
