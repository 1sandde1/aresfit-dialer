...
assert(index.includes('aresfit-dialer-sandde-v2.html?v=20260714-classic-layout-r1'), 'the repository entry link must cache-bust to the verified build');
...
assert(html.includes("const APP_BUILD = '2026.07.14.1'"), 'the visible build identifier is missing');
