...
assert(index.includes('aresfit-dialer-sandde-v2.html?v=20260715-compact-mobile-r1'), 'the repository entry link must cache-bust to the verified build');
...
assert(html.includes("const APP_BUILD = '2026.07.15'"), 'the visible build identifier is missing');
