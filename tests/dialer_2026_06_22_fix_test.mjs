...
assert(index.includes('aresfit-dialer-sandde-v2.html?v=20260825-owr-001-mobile-r1'), 'the repository entry link must cache-bust to the verified build');
...
assert(html.includes("const APP_BUILD = '2026.08.25'"), 'the visible build identifier is missing');
